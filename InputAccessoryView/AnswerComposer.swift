...
class AnswerComposer: UIView {
    ...
    lazy var textView: TextView = {
        ...
        let textView = TextView.newAutoLayout()
        ...
        textView.backgroundColor = UIColor(red: 0.98, green: 0.98, blue: 0.9, alpha: 1.0)
    ...
    lazy var sendButton: UIButton = {
        ...
        sendButton.titleLabel!.font = UIFont.systemFont(ofSize: 12.0)
        
        sendButton.backgroundColor = UIColor(red: 0.98, green: 0.98, blue: 0.9, alpha: 1.0)
